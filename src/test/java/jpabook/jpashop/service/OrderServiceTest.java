...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("인어공주", 10000, 10);
    ...
    public void 주문취소() throws Exception {
        //given
        Member member = createMember();
        Book item = createBook("인어공주", 10000, 10);
        ...
        //then
        Order getOrder = orderRepository.findOne(orderId);
        Assert.assertEquals("주문 취소 시 상태는 CANCEL이 되어야 한다.", OrderStatus.CANCEL, getOrder.getStatus());
    ...
    public void 상품주문_재고수량초과() throws Exception {
        //given
        Member member = createMember();
        Item item = createBook("인어공주", 10000, 10);
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("부산", "강가", "123-456"));
        em.persist(member);
        return member;
    }
